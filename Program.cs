...
var venus = new
{
    ...
    Number = 2,
    EquatorLength = 38052,
    PreviousPlanet = (dynamic?)null
};

Console.WriteLine("Название: " + venus.Name + "\n" +
    "Номер от солнца: " + venus.Number + "\n" +
    "Длина экватора: " + venus.EquatorLength + "\n" +
    "Предыдущая планета: " + (venus.PreviousPlanet == null ? "null" : venus.PreviousPlanet.Name));
...
Console.WriteLine("Название: " + earth.Name + "\n" +
    ...
    "Предыдущая планета: " + (earth.PreviousPlanet == null ? "null" : earth.PreviousPlanet.Name));
...
Console.WriteLine("Название: " + mars.Name + "\n" +
    ...
    "Предыдущая планета: " + (mars.PreviousPlanet == null ? "null" : mars.PreviousPlanet.Name));
...
Console.WriteLine("Название: " + venus1.Name + "\n" +
    ...
    "Предыдущая планета: " + (venus1.PreviousPlanet == null ? "null" : venus1.PreviousPlanet.Name));
